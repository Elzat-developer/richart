...
export const HouseholdCategoriesPage: React.FC = () => {
			...
			<div className="min-h-screen bg-gray-50">
				<div className="container mx-auto px-4 py-16">
					<div className="text-center mb-12">
						<h1 className="text-4xl font-bold text-gray-900 mb-4">Бытовые категории</h1>
			...
			<div className="container mx-auto px-4 py-16">
				...
				<div className="text-center mb-12">
					...
					<p className="text-lg text-gray-600 max-w-2xl mx-auto">
						Выберите интересующую вас категорию для просмотра бытового оборудования.
					...
					{currentCategories.map((category) => {
						...
						return (
							<Link
								...
								to={`/household-catalog?categoryId=${categoryAny.categoryId || category.categoryId}`}
